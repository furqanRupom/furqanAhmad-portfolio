...
const About = () => {
  return (
    <div id="#about" className="min-h-screen bg-slate-900 -mt-60">
      ...
      <section className="grid grid-cols-1  lg:grid-cols-[1fr,4fr] justify-items-center lg:justify-items-stretch  max-w-7xl mx-auto px-8 lg:px-0 gap-5">
        <div>
          <Image
            height={400}
        ...
        <div className="text-white grid grid-cols-1 lg:grid-cols-[4fr,1fr] items-center gap-x-12">
          ...
          <div>
            <div className=" text-[100px] lg:text-[80px] xl:text-[100px] bg-purple-900/25 w-24 h-24 relative rounded-[100%] lg:mx-auto mt-5 lg:mt-0">
              <h3 className="absolute -top-5 -left-4 lg:-top-0 lg:-left-0 xl:-top-5 xl:-left-4">20</h3>
            </div>

            <p className="py-3 text-lg  lg:text-center">Projects completed</p>
          </div>
        </div>
      </section>

      <div className="text-white  md:text-lg  grid grid-cols-2 lg:grid-cols-4 gap-y-3  md:gap-10  lg:items-center lg:justify-items-center max-w-7xl mx-auto w-full pt-8 pb-20 px-3">
        <p>
